...
xint32_t RM_CBB_ProQuickTransWrite(ProQuickTransHandle h, xint32_t id, xbyte_t * data, xint32_t lenOfData, xint32_t interval, xint32_t timeout)
{
    RM_CODE::ProQuickTrans * handle = (RM_CODE::ProQuickTrans *)h;
    if (handle != NULL)
    {
...
xint32_t RM_CBB_ProQuickTransRead(ProQuickTransHandle h, ProQuickTransNodeIndex_t * IN, xint32_t id, xbyte_t * data, xint32_t sizeOfData, xint32_t interval, xint32_t timeout)
{
    RM_CODE::ProQuickTrans * handle = (RM_CODE::ProQuickTrans *)h;
    if (handle != NULL)
    {
